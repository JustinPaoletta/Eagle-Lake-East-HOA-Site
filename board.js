...
if (date.getMonth() === 11 && date.getDate() === 25) {
    ...
    document.getElementById('ONE').classList.replace('card1', 'christmascard1');
    document.getElementById('TWO').classList.replace('card1', 'christmascard1');
    document.getElementById('THREE').classList.replace('card1', 'christmascard1');
    document.getElementById('FOUR').classList.replace('card1', 'christmascard1');
     document.getElementById('one').classList.replace('cards', 'christmascards');
    document.getElementById('two').classList.replace('cards', 'christmascards');
    document.getElementById('three').classList.replace('cards', 'christmascards');
    document.getElementById('four').classList.replace('cards', 'christmascards');
...
if (date.getMonth() === 0 && date.getDate() === 1) {
    ...
    document.getElementById('ONE').classList.replace('card1', 'newyearcard1');
    document.getElementById('TWO').classList.replace('card1', 'newyearcard1');
    document.getElementById('THREE').classList.replace('card1', 'newyearcard1');
    document.getElementById('FOUR').classList.replace('card1', 'newyearcard1');
     document.getElementById('one').classList.replace('cards', 'newyearcards');
    document.getElementById('two').classList.replace('cards', 'newyearcards');
    document.getElementById('three').classList.replace('cards', 'newyearcards');
    document.getElementById('four').classList.replace('cards', 'newyearcards');
...
if (date.getMonth() === 0 && date.getDate() === 20) {
    ...
    document.getElementById('ONE').classList.replace('card1', 'mlkcard1');
    document.getElementById('TWO').classList.replace('card1', 'mlkcard1');
    document.getElementById('THREE').classList.replace('card1', 'mlkcard1');
    document.getElementById('FOUR').classList.replace('card1', 'mlkcard1');
     document.getElementById('one').classList.replace('cards', 'mlkcards');
    document.getElementById('two').classList.replace('cards', 'mlkcards');
    document.getElementById('three').classList.replace('cards', 'mlkcards');
    document.getElementById('four').classList.replace('cards', 'mlkcards');
...
if (date.getMonth() === 1 && date.getDate() === 17) {
    ...
    document.getElementById('ONE').classList.replace('card1', 'uscard1');
    document.getElementById('TWO').classList.replace('card1', 'uscard1');
    document.getElementById('THREE').classList.replace('card1', 'uscard1');
    document.getElementById('FOUR').classList.replace('card1', 'uscard1');
     document.getElementById('one').classList.replace('cards', 'uscards');
    document.getElementById('two').classList.replace('cards', 'uscards');
    document.getElementById('three').classList.replace('cards', 'uscards');
    document.getElementById('four').classList.replace('cards', 'uscards');
...
if (date.getMonth() === 10 && date.getDate() === 26) {
    ...
    document.getElementById('ONE').classList.replace('card1', 'thankscard1');
    document.getElementById('TWO').classList.replace('card1', 'thankscard1');
    document.getElementById('THREE').classList.replace('card1', 'thankscard1');
    document.getElementById('FOUR').classList.replace('card1', 'thankscard1');
     document.getElementById('one').classList.replace('cards', 'thankscards');
    document.getElementById('two').classList.replace('cards', 'thankscards');
    document.getElementById('three').classList.replace('cards', 'thankscards');
    document.getElementById('four').classList.replace('cards', 'thankscards');
